...
?>
<div class="container">
    <h2 class="text-capitalize  text-muted">la liste des filier</h2>
    ...
    <table class="table table-bordered table-striped container text-center " >
        ...
        ?>
                <tr>
                    <th scope="col">ID filier</th>
                    <th scope="col">Nom</th>
                    <th colspan="2" scope="col"> Action</th>
                </tr>
        <?php

            foreach ($list_filier as $key => $value) 
            { 
                ?>
                    <tr>
                        ...
                        <td> 
                            ...
                            href="index.php?action=supp&type=filier&login=<?=$value->id_filier ?>">
                            <i class="bi bi-trash"></i>
                        </a>
                        </td>
                        <td>
                            <a class="btn btn-outline-primary m-0" h href="index.php?action=modifier&type=filier&id=<?=$value->id_filier ?>&mody=<?=$value->id_filier ?>">
